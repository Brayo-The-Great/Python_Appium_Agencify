...
class TestAppium(unittest.TestCase):
    ...
    def quote_details_screen(self):
        el = WebDriverWait(self.driver, 90).until(EC.element_to_be_clickable(
            (By.XPATH, '//android.view.ViewGroup[@resource-id="insure.agencify.agencify:id/selectPlan"]/android.widget.ImageView')))  # Select Payment Plan
        el.click()

        el = WebDriverWait(self.driver, 90).until(EC.element_to_be_clickable(
            (By.XPATH, '//androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[1]/android.view.View[2]')))  # 40:30:30
        el.click()
